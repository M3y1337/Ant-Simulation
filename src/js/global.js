...
export const Global = {
    food: new QuadTree(fullScreenRect, Config.quadTreeCapacity || 4),
    bluePheromones: new QuadTree(fullScreenRect, Config.quadTreeCapacity || 4),
    redPheromones: new QuadTree(fullScreenRect, Config.quadTreeCapacity || 4),
    tool: 0,
    ...
    obstacleTree: new QuadTree(fullScreenRect, Config.quadTreeCapacity || 4),
};
